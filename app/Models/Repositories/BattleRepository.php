...
* Now supports the 'is_hidden' flag for anonymous attacks.
*
...
attacker_offense_power, defender_defense_power, is_hidden, created_at)
VALUES
(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())
";
...
$attackerOffensePower, $defenderDefensePower, (int)$isHidden
]);
...
* Includes attacker name join (which may be masked in view later if is_hidden is true).
*
* @param int $defenderId
* @return BattleReport[]
*/
