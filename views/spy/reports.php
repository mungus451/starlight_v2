<style>
    ...
    .report-item-result.success {
        color: #4CAF50;
        font-weight: bold;
    }
    .report-item-result.failure {
        color: #e53e3e;
        font-weight: bold;
    }
</style>
...
<div class="reports-container">
    ...
    <div class="data-card">
        <h3>Inbox</h3>
        <a href="/spy" class="btn-submit" style="text-align: center; display: block; margin-bottom: 1.5rem;">Back to Spy Command</a>

        <ul class="report-list">
            <?php if (empty($reports)): ?>
                <li style="text-align: center; color: #c0c0e0;">You have no spy reports.</li>
            <?php else: ?>
