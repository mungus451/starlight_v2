...
<div class="mobile-card">
    ...
    <div class="mobile-card-content" style="display: block;">
        <ul class="mobile-stats-list">
            ...
            <li><span><i class="fas fa-atom value-green"></i> Dark Matter / Turn</span> <strong class="value-green">+ <?= number_format($incomeBreakdown['dark_matter_income']) ?></span></strong></li>
            <li><span><i class="fas fa-gem value-green"></i> Naquadah / Turn</span> <strong class="value-green">+ <?= $formatted_naquadah_per_turn ?></span></strong></li>
        </ul>
    </div>
</div>
...
<div class="mobile-card">
    ...
    <div class="mobile-card-content" style="display: block;">
        <ul class="mobile-stats-list">
            ...
            <li><span><i class="fas fa-gem"></i> Naquadah Crystals</span> <strong><?= $formatted_naquadah_crystals ?></strong></li>
        </ul>
